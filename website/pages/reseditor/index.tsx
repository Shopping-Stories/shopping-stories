...
const ResView: NextPage = () => {
    ...
    const doUpload = async (toUp: fileUploads) => {
        ...
        const parse_url = "https://preprod.shoppingstories.org:4562/upload_and_parse_multi/";
    ...
    async function CheckParsing(wait = false) {
        ...
        const checkUrl = "https://preprod.shoppingstories.org:4562/get_parser_progress";
    ...
    const handleDelete = async () => {
        const delUrl = "https://preprod.shoppingstories.org:4562/del_ready_files"
    ...
    const handleDBSave = async () => {
        const saveUrl = "https://preprod.shoppingstories.org:4562/create_entries";

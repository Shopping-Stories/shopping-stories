...
const adminLinks: NavLink[] = [
    ...
    { title: `combine people`, path: `/dashboard/people` },
    { title: `combine items`, path: `/dashboard/items` },
    { title: `manage people`, path: `/dashboard/managepeople` },
    { title: `manage items`, path: `/dashboard/manageitems` },

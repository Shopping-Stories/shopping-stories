		...
		<>
			<div className={backgrounds.colorBackground}>
						...
						>
							<ItemsPaginationTable
								...
								onEditClick={(row: any) => {
									...
									updateForm.setFieldValue('variants', row.variants);
									handleOpenUpdate();
									console.log('edit', row);
								}}
								onDeleteClick={async (row: any) => {
									setItemToDelete({ item: row.item, id: row.id });
									handleOpenDelete();
								}}
								search={search}
								reQuery={reQuery}
					...
					<form onSubmit={updateForm.handleSubmit}>
						<DialogContent>
							...
							<TextField
								...
								error={
									updateForm.touched.item && Boolean(updateForm.errors.item)
								}
								helperText={updateForm.touched.item && updateForm.errors.item}
							/>
							<TextField
								fullWidth
								margin="dense"
								...
								helperText={
									updateForm.touched.variants && updateForm.errors.variants
								}
							/>
						</DialogContent>
						<DialogActions>
					...
					<form onSubmit={createForm.handleSubmit}>
						<DialogContent>
							...
							<TextField
								...
								error={
									createForm.touched.item && Boolean(createForm.errors.item)
								}
								helperText={createForm.touched.item && createForm.errors.item}
							/>
							<TextField
								fullWidth
								margin="dense"
								...
								helperText={
									createForm.touched.variants && createForm.errors.variants
								}
							/>
						</DialogContent>
						<DialogActions>
				...
				<Dialog open={openDelete} onClose={handleCloseDelete}>
					<DialogTitle>Confirm Delete of {itemToDelete && itemToDelete.item}</DialogTitle>
					<DialogContent>
						<DialogContentText>
							Are you sure you want to delete {itemToDelete && itemToDelete.item}
						</DialogContentText>
					</DialogContent>
					<DialogActions>

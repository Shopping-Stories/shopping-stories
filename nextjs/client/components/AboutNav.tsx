                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                communities whose stories were not historically
                                told. Using historic documents, artifacts,
                                buildings, and the landscape, we connect the
                            ...
                            <p className={styles.about}>
                                ...
                                discoveries. We create digital presentations and
                            ...
                            <p className={styles.about}>
                                ...
                                strategies to further advance the understanding
                                of historically forgotten individuals and
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                from the typical prose of a letter or diary
                                entry, however, they include as much, if not
                                more, significant information to assist in the
                                understanding of the past given they describe
                                numerous people, places, objects, economies,
                                politics, religion, etc., all from a single
                                community. Ledgers especially reveal insights
                                into the lives of less recognized members of a
                                community, like women and the enslaved, through
                            ...
                            >
                                ...
                                through December 17, 1761. With an individual
                                account, she had money of her own, and the use
                                of the title ‘Mrs.’ indicates she was most
                                likely a widow. Connell’s account shows she had
                                at least two children – an unnamed daughter and
                                a son, Giles – both who made purchases against
                                her account. She was responsible for people and
                                property, as on June 25, 1761, she paid the
                                sheriff and parish collector tithes and levies
                                for two people and at least 400 acres of land.
                                While she was not responsible for paying a tithe
                                on herself, the two individuals may have either
                                been enslaved or a white male over the age of 16
                                years (her son?). On this same day, she paid her
                                account in tobacco and purchased a reap hook and
                                nacconies (an Indian striped calico usually
                                associated with clothing of the enslaved), thus
                                it is likely she was responsible for at least
                                one enslaved individual who farmed the tobacco.
                                Connell was connected to at least three men –
                                Giles, John Ford, and Sampson Turley – as they
                                appeared as either a purchaser on her account
                                (Giles purchased hats, Ford purchased buttons)
                                or someone Connell paid (Turley with tobacco).
                                She owned a firearm as she purchased shot (as
                                did her son). The remainder of her purchases
                                were typical of most customers to the store with
                                a focus on materials to make clothing (fabrics,
                            ...
                            <p className={styles.about}>
                                ...
                                elements without attempting to understand the
                                community in its entirety. Using store ledgers,
                                Shopping Stories intends to develop a
                                prosopography to uncover consumer interests,
                                lives, and the larger community of people in the
                                18th century through an online, searchable
                                database.
                            </p>
                        </Typography>
                    </Paper>
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                the records of twenty identified branch stores
                                in the Tidewater of Virginia and Maryland. These
                                store accounts capture a moment in time – at the
                                height of the colonial tobacco trade when access
                                to consumer goods extended not only to upper
                                class planters, but increasingly to the middle
                                and lower classes including craftspeople,
                            ...
                            <p className={styles.about}>
                                ...
                                with history students to explore the people,
                                places, and objects found within the 1760/1761
                                ...
                                places found in the ledger. The UCF partnership
                                is culminating in the development of this
                                prototype web application to provide the
                                ledger’s data in a publicly accessible format
                            ...
                            <p className={styles.about}>
                                ...
                                with Great Britain. The goal is to better
                                understand the community who frequented these
                                stores, what they purchased, how they paid for
                                their goods - a glimpse into their lives and the
                                local economy of Northern Virginia from
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                crowd-sourced, citizen-historian model. A ledger
                                page template and transcription manual provided
                                methodology and guidance and an evolving
                                glossary of words and abbreviations assisting
                                those unfamiliar with cursive handwriting and
                                18th-century terminology. After reviewing the
                                reference materials, volunteers transcribed a
                                practice set of pages to a ssess their basic
                                level of understanding of both the instructions
                                and the original manuscripts. Next, being
                                provided individualized assistance throughout,
                                volunteers were sent the images of folios to
                                transcribe into spreadsheets and return for
                                review and additional feedback. The transcripts
                            ...
                            <p className={styles.about}>
                                ...
                                the original, volunteers inserted assumed
                                information, abbreviations, and standardized
                                spellings in square brackets adjacent to the
                                original text. The text included in the database
                                is currently limited to those standardizations
                                of abbreviations (e.g. oz = ounce(s)), spelling
                                (e.g. ozenbrigs = osnaburg), and insertion of
                                words needed to understand the transactions
                                (e.g. ditto = what was being repeated). For
                                inclusion in the database, when multiple items
                                were grouped together in a single purchase, they
                            ...
                            <p className={styles.about}>
                                ...
                                information on how to search the database and as
                                additional pages are added. Note: an account
                                will not be required to access the ledger
                                information.
                            </p>
                        </Typography>
                    </Paper>
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                was purchased when, and how purchases were paid.
                                Ledgers were used by anyone who ran a business
                                from tradesmen like tailors, blacksmiths, and
                                printers to those who operated general stores
                                like the two History Revealed, Inc. (HRI) is
                                currently studying in Colchester and Alexandria,
                                Virginia.
                            </p>
                        </Typography>
                    </Paper>
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                entered into a day book, by date. At the end of
                                the year, the day book would be converted into
                                an account ledger organized by customer
                                providing the business owner a legal record of
                                all the customers, what was purchased/when, and
                                who still owed money. As the legal record of the
                            ...
                            <p className={styles.about}>
                                ...
                                listed all the payments (credits). Each account
                                began with the customer’s name, and sometimes a
                                profession, location of residence, familiar
                                relationships, and/or who provided security (the
                                person responsible for paying the account if the
                                customer didn’t). The account information
                                appeared either entirely above the purchases or
                                spread across both pages. Beneath the account
                                information appeared the transactions (either
                                purchases or payments) by date with a matching
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                account after harvests of tobacco or other
                                crops. Most purchases of goods and services were
                                not done through bartering, but with credit;
                            ...
                            <p className={styles.about}>
                                ...
                                account holder or paid to others by the store on
                                the customer’s behalf. Each row begins with a
                                date, the word ‘To’ indicating the transaction
                                results in a debt to the store, and then a list
                                of transactions or purchases that occurred with
                                a total on the far right. When lots of items
                                were purchased or transactions occurred on the
                                same day, rather than repeat the date again and
                            ...
                            <p className={styles.about}>
                                ...
                                to payments made by others. Similar to the debit
                                side, each transaction begins with a date, this
                                time with the word ‘By’ which tells us the
                                transaction will be paying the store, and then a
                                list of transactions or payments that occurred
                                with a total on the far right. And like the
                                debit page, when transactions occurred on the
                                same day, the author created a list rather than
                                repeating the date each time. Payments in
                                tobacco included the crop or transfer note
                                information provided at the tobacco warehouse
                ...
                <Grid container spacing={2}>
                    ...
                    >
                        <Typography>
                            ...
                            >
                                Learning more about the people and places in the
                            ...
                            <b className={styles.about}>
                                ...
                                Cruz, Robin Dunn, Charlotte Fennell, Kevin
                                Gushman, Louise Haven, Andrew Heer, Morgan
                                Holman, Mary & Alex Hughes, Molly Kerr, Altuan
                                McGarvin, Teresa Mock, Sarah Myers, Sebastian
                                Orrego, Christopher Owen, Nicholas Powers,
                                Marian Price, Danielle Rodriguez, Rebecca
                                Rodriguez, Jon Sanders, Richard Sickles, Allison
                            ...
                            <p className={styles.about}>
                                ...
                                places, and objects found within the ledgers
                                through research papers, blog posts, posters,
                                infographics, website mock-ups, and theses
                                through history classes with Dr. Rosalind Beiler
                                (The Atlantic World, 1400-1900; Colonial
                    ...
                    >
                        <Typography>
                            ...
                            <p className={styles.about}>
                                ...
                                , from the John Glassford and Company Records.
